  ...
  protected JComponent createDisclosedComponent(int state) {
    ...
    switch (state) {
      case 1:
        ...
        gbc.gridy = 0;
        btn = new JButton(d = new AlignAction(editor, new WestAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        btn.setText(null);
        p.add(btn, gbc);
        gbc.insets = new Insets(0, 3, 0, 0);
        btn = new JButton(d = new AlignAction(editor, new EastAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        ...
        btn = new JButton(d = new AlignAction(editor, new NorthAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        btn.putClientProperty("hideActionText", Boolean.TRUE);
        btn.setText(null);
        ...
        btn = new JButton(d = new AlignAction(editor, new SouthAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        btn.putClientProperty("hideActionText", Boolean.TRUE);
        btn.setText(null);
        ...
        gbc.gridy = 2;
        gbc.insets = new Insets(3, 0, 0, 0);
        btn = new JButton(d = new AlignAction(editor, new HorizontalAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        btn.putClientProperty("hideActionText", Boolean.TRUE);
        btn.setText(null);
        ...
        gbc.gridx = 1;
        gbc.insets = new Insets(3, 3, 0, 0);
        btn = new JButton(d = new AlignAction(editor, new VerticalAlignmentStrategy()));
        disposables.add(d);
        btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
        btn.putClientProperty("hideActionText", Boolean.TRUE);
        btn.setText(null);
